...
def main():
    exif = read_exif("C:/Users/myzbt/DevOps_HW_Python/files/photos/2.jpg")
    coordinates = get_coordinates(exif)
    write_coordinates_to_csv("C:/Users/myzbt/DevOps_HW_Python/files/coordinates.csv", coordinates)
